...
public class AddPaymentPurchaseReturnPage extends AbstractComponents {
    WebDriver driver;
    ...
    public AddPaymentPurchaseReturnPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    public AllPurchaseReturnsPage clickCreatePaymentButton() {
