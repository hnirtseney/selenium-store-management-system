...
public class CreatePurchasePage extends AbstractComponents {
    WebDriver driver;
    Select select;
    // Web elements
    ...
    @FindBy(xpath = "//*[@id=\"purchase-form\"]/div[2]/div[1]/div/table/tbody/tr/td[4]/div/input")
    WebElement productQuantity;
    @FindBy(xpath = "//*[@id=\"purchase-form\"]/div[2]/div[1]/div/table/tbody/tr/td[4]/div/div/button")
    WebElement productQuantityButton;
    @FindBy(xpath = "//*[@id=\"purchase-form\"]/div[2]/div[2]/div/div/table/tbody/tr[4]/th[2]")
    ...
    @FindBy(xpath = "//*[@id=\"purchase-form\"]/div[2]/div[3]/div[3]/div/input")
    ...
    public AllPurchasesPage clickSubmitButton() {
        submitButton.click();
