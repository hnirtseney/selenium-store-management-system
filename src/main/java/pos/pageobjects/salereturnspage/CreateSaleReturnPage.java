...
public class CreateSaleReturnPage extends AbstractComponents {
    WebDriver driver;
    Select select;
    // Web elements
    ...
    @FindBy(xpath = "//*[@id=\"sale-return-form\"]/div[2]/div[1]/div/table/tbody/tr/td[4]/div/input")
    WebElement productQuantity;
    @FindBy(xpath = "//*[@id=\"sale-return-form\"]/div[2]/div[1]/div/table/tbody/tr/td[4]/div/div/button")
    WebElement productQuantityButton;
    @FindBy(xpath = "//*[@id=\"sale-return-form\"]/div[2]/div[2]/div/div/table/tbody/tr[4]/th[2]")
    ...
    @FindBy(xpath = "//*[@id=\"sale-return-form\"]/div[2]/div[3]/div[3]/div/input")
    ...
    @FindBy(xpath = "//*[@id=\"sale-return-form\"]/div[5]/button")
    WebElement submitButton;

    // Constructor
    public CreateSaleReturnPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    public void selectCustomer(String supplier) {
    ...
    public void inputAmount(String typeAmount) throws InterruptedException {
        ...
        if (Objects.equals(typeAmount, "Partial")) {
            System.out.println(roundedPartialAmount);
    ...
    public AllSaleReturnsPage clickSubmitButton() {
        submitButton.click();
