...
public class LoginFailedTest extends BaseTest {
    ...
    public Object[][] getLoginFailureData() throws IOException {
        List<HashMap<String, String>> data = getJsonDataToMap(System.getProperty("user.dir") + "//src//test//java//pos//data//logindata//LoginFailed.json");
        return data.stream().map(d -> new Object[] { d.get("email"), d.get("password"), d.get("invalid-feedback")}).toArray(Object[][]::new);
    }
